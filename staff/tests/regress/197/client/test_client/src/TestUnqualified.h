...
#ifndef _TEST_DEFAULT_UNQUALIFIED_H_
#define _TEST_DEFAULT_UNQUALIFIED_H_
...
// *interface.targetNamespace: http://tempui.org/test/TEST_DEFAULT_UNQUALIFIED

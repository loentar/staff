...
i18n.webapp =
{
  ...
  // view.DlgList
  'List': 'Список',
  'Select a item': 'Выберите элемент из списка',
  ...
  'Add subobject': 'Добавить подобъект',
  ...
  'to': 'в',
  'Error while saving object': 'Ошибка при сохранении объекта',
  'Save object first': 'Необходимо сначала сохранить объект',
  'New object': 'Новый объект',
  'Remove object': 'Удалить объект',
  'and all childs': 'и все дочерние объекты',
  'Error while removing object': 'Ошибка при удалении объекта',

...
//template std::list<int>
      aResult[j++] = parseInt(tResult.childNodes[i].firstChild.nodeValue);
    }
  }
...
staff.admin.AccountAdmin.prototype =
{
  initialize: function(sServiceUri, sSessionId, sInstanceId, sTargetNamespace)
  {
    if (!sServiceUri)
    {
      sServiceUri = webapp.Env.protocol + webapp.Session.sHost + (webapp.Session.sPort ? (':' + webapp.Session.sPort) : '') + '/axis2/services/staff.admin.AccountAdmin';
    }

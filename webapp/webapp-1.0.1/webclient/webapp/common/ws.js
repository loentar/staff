...
var XML = {
  ...
  getElementsByQName : function(element, qname) {
    ...
    if(!element.getElementsByTagNameNS) {
      nl = new Array();
      var sNodeName = qname.value_of();
      var nodes = element.getElementsByTagName(sNodeName);
      for (var n = 0; n < nodes.length; n++) {
        if (nodes[n].namespaceURI == qname.namespace || qname.namespace == null) {
          nl.push(nodes[n]);
        }
      }
    } else {
...
WS.QName.prototype = {
  initialize : function(localpart) {
    ...
    if (arguments[1] != null) this.namespace = arguments[1];
    if (arguments[2] != null) this.prefix = arguments[2];
  },
  to_string : function() {
...
SOAP.Element.prototype = {
  initialize : function() {
    if (arguments[0] != null) this.initialize_internal(arguments[0]);
  },
  ...
  declare_namespace : function(qname) {
    var ns = new WS.QName(
      qname.prefix, 
  ...
  add_child : function(element) {
    var doc = this.element.ownerDocument;
    if (element instanceof SOAP.Element) {
...
WS.Call.prototype = {
  ...
  invoke : function(envelope, callback, error_callback) {
    ...
    options.onComplete = 
      function(transport) 
      {
        try 
        {
          ...
          if (xml == null)
            throw new Error("Response Xml object is null!");
          if (xml.documentElement == null)
            throw new Error("Response Xml-Document object is null!");
          ...
          try
          {
            if(transport.status == 200)
            {
              ...
              callback(this, responseEnv, transport);
            }
            else
            {
              call.invokeHandlers(call,e,transport,'error');
              error_callback(this, responseEnv, transport);
            }
          }
          catch(e) {}
        }

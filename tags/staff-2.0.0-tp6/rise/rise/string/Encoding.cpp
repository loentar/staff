...
namespace rise
{
  ...
  inline void AddEncodingType(CEncoding::TEncMap& rEncMap, const SEncodingType& rstEncType)
  {
    rEncMap.insert(CEncoding::TEncMap::value_type(rstEncType.nID, rstEncType));
  }

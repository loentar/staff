...
#ifndef _STAFFXMLEXPORT_H_
#define _STAFFXMLEXPORT_H_
  ...
  #ifdef STAFF_XML_DLL_EXPORTS
    #define STAFF_XML_EXPORT __declspec(dllexport)
  #else
    #define STAFF_XML_EXPORT __declspec(dllimport)
  #endif
#else
  #define STAFF_XML_EXPORT 
#endif
